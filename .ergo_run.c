...
static void cogito_invoke_draw_handler(ErgoVal handler, cogito_node* node,
  ...
  if (handler.tag != EVT_FN) return;
  ErgoVal args[3] = {cogito_wrap_node(node, COGITO_HANDLE_NODE), EV_INT(width),
                     EV_INT(height)};
...
static ErgoVal __cogito_app_set_accent_from_image(ErgoVal appv, ErgoVal pathv, ErgoVal follow_systemv) {
  ...
  if (tmp) ergo_release_val(EV_STR(tmp));
  if (!hex || !hex[0]) return EV_NULLV;
  return EV_STR(stdr_str_lit(hex));
}
...
static void __cogito_card_set_subtitle(ErgoVal cardv, ErgoVal subtitlev) {
  ...
  if (ts && subtitlev.tag != EVT_STR) ergo_release_val(EV_STR(ts));
...
static void __cogito_card_set_header_image(ErgoVal cardv, ErgoVal urlv) {
  ...
  if (n->card.header_image) {
    ergo_release_val(EV_OBJ(n->card.header_image));
...
static void __cogito_card_add_overflow(ErgoVal cardv, ErgoVal labelv, ErgoVal handler) {
  ...
  if (!card->card.overflow_btn) {
    ...
    ergo_release_val(EV_STR(icon_str));
...
static ErgoVal __cogito_drawing_area_get_x(ErgoVal dav) {
  cogito_node* da = cogito_node_from_val(dav);
  return EV_INT(cogito_drawing_area_get_x(da));
}
static ErgoVal __cogito_drawing_area_get_y(ErgoVal dav) {
  cogito_node* da = cogito_node_from_val(dav);
  return EV_INT(cogito_drawing_area_get_y(da));
}
static ErgoVal __cogito_drawing_area_get_pressed(ErgoVal dav) {
  cogito_node* da = cogito_node_from_val(dav);
  return EV_BOOL(cogito_drawing_area_get_pressed(da));
}
...
static ErgoVal __cogito_shape_get_preset(ErgoVal shapev) {
  cogito_node* n = cogito_node_from_val(shapev);
  return EV_INT(cogito_shape_get_preset(n));
}
...
static ErgoVal __cogito_shape_get_size(ErgoVal shapev) {
  cogito_node* n = cogito_node_from_val(shapev);
  return EV_INT(cogito_shape_get_size(n));
}
...
static ErgoVal __cogito_shape_get_color_style(ErgoVal shapev) {
  cogito_node* n = cogito_node_from_val(shapev);
  return EV_INT(cogito_shape_get_color_style(n));
}
...
static ErgoVal __cogito_shape_get_vertex_x(ErgoVal shapev, ErgoVal idxv) {
  cogito_node* n = cogito_node_from_val(shapev);
  return EV_FLOAT((double)cogito_shape_get_vertex_x(n, (int)ergo_as_int(idxv)));
}
static ErgoVal __cogito_shape_get_vertex_y(ErgoVal shapev, ErgoVal idxv) {
  cogito_node* n = cogito_node_from_val(shapev);
  return EV_FLOAT((double)cogito_shape_get_vertex_y(n, (int)ergo_as_int(idxv)));
}
// --- ContentList ---
...
static ErgoVal __cogito_colorpicker_get_hex(ErgoVal cpv) {
  ...
  return EV_STR(stdr_str_lit(hex ? hex : ""));
}
...
static void __cogito_timer_cb_call_ergo(void* user) {
  ...
  if (!fn) return;
  ErgoVal ret = ergo_call(EV_FN(fn), 0, NULL);
  ergo_release_val(ret);
}
...
static ErgoVal __cogito_timer_timeout(ErgoVal delayv, ErgoVal handlerv) {
  ...
  if (id == 0) ergo_release_val(EV_FN(fn));
  return EV_INT((int64_t)id);
}
...
// ---- cask globals ----
static ErgoVal ergo_g_main_gafu_app = EV_NULLV;
static ErgoVal ergo_g_main_source_picker = EV_NULLV;
static ErgoVal ergo_g_main_upload_hint = EV_NULLV;
static ErgoVal ergo_g_main_scheme_switch = EV_NULLV;
static ErgoVal ergo_g_main_source_hex = EV_NULLV;
static ErgoVal ergo_g_main_selected_image_path = EV_NULLV;
static ErgoVal ergo_g_main_selected_image_preview = EV_NULLV;
static ErgoVal ergo_g_main_ENSOR_DEFAULT = EV_NULLV;
static ErgoVal ergo_g_main_ENSOR_CONTENT = EV_NULLV;
static ErgoVal ergo_g_main_mode_moon = EV_NULLV;
static ErgoVal ergo_g_main_mode_base = EV_NULLV;
static ErgoVal ergo_g_main_mode_bright = EV_NULLV;
static ErgoVal ergo_g_main_mode_brightest = EV_NULLV;
static ErgoVal ergo_g_main_dark_switch = EV_NULLV;
...
static void ergo_init_main(void) {
  ...
  ErgoVal __t3 = EV_STR(stdr_str_lit("#65558F"));
  ...
  ErgoVal __t6 = EV_STR(stdr_str_lit("Choose an Image or Drop Here…"));
  ErgoVal __t7 = EV_NULLV;
  {
  ...
  ErgoVal __t21 = EV_STR(stdr_str_lit("sf:sun.max"));
  ErgoVal __t22 = EV_NULLV;
  {
  ...
  ErgoVal __t24 = EV_STR(stdr_str_lit("sf:sun.lefthalf.filled"));
  ErgoVal __t25 = EV_NULLV;
  {
  ...
  ErgoVal __t27 = EV_STR(stdr_str_lit("sf:sun.max.fill"));
  ErgoVal __t28 = EV_NULLV;
  {
  ...
  ErgoVal __t30 = EV_STR(stdr_str_lit("Dark Mode"));
  ErgoVal __t31 = EV_NULLV;
  {
...
static void ergo_main_choose_source_image(void) {
  ErgoVal picked__2 = EV_NULLV;
  ErgoVal __t46 = EV_STR(stdr_str_lit("Choose image"));
  ...
  ErgoVal __t48 = EV_STR(stdr_str_lit("png"));
  ErgoVal __t49 = EV_NULLV;
  {
  ...
  ErgoVal path__4 = EV_NULLV;
  ErgoVal __t53 = picked__2; ergo_retain_val(__t53);
  ErgoVal __t54 = EV_STR(stdr_to_string(__t53));
  ...
  ErgoVal __t65 = EV_STR(stdr_str_lit("Image Selected."));
  ErgoVal __t66 = EV_NULLV;
  {
  ...
  ErgoVal __t72 = EV_INT(320);
  ErgoVal __t73 = EV_INT(180);
  ...
  ErgoVal __t83 = EV_STR(stdr_str_lit(""));
...
static void ergo_main_reset_everything(void) {
  ErgoVal __t87 = EV_STR(stdr_str_lit(""));
  ...
  ErgoVal __t90 = EV_STR(stdr_str_lit("Choose File Or Drag & Drop Here…"));
  ErgoVal __t91 = EV_NULLV;
  {
  ...
  ErgoVal __t94 = EV_STR(stdr_str_lit(""));
  ...
  ErgoVal __t97 = EV_INT(0);
  ErgoVal __t98 = EV_INT(0);
  ...
  ErgoVal __t109 = EV_STR(stdr_str_lit("#65558F"));
  ErgoVal __t110 = EV_NULLV;
  {
  ...
  ErgoVal __t111 = EV_NULLV;
  ergo_release_val(__t111);
  ErgoVal __t112 = EV_INT(1);
  ...
  ErgoVal __t125 = EV_BOOL(false);
  ErgoVal __t126 = EV_BOOL(false);
...
static ErgoVal ergo_main_fixed_column(ErgoVal a0, ErgoVal a1, ErgoVal a2, ErgoVal a3, ErgoVal a4, ErgoVal a5, ErgoVal a6, ErgoVal a7) {
  ErgoVal __ret = EV_NULLV;
  ErgoVal col__10 = EV_NULLV;
  ErgoVal __t162 = ergo_cogito_vstack();
  ErgoVal __t163 = EV_BOOL(true);
  ...
  ErgoVal top__11 = EV_NULLV;
  ErgoVal __t165 = ergo_cogito_hstack();
  ErgoVal __t166 = EV_BOOL(true);
...
static void ergo_main_set_mode_selection(ErgoVal a0, ErgoVal a1, ErgoVal a2, ErgoVal a3, ErgoVal a4) {
  ...
  ErgoVal __t213 = EV_NULLV;
  ErgoVal __t214 = a0; ergo_retain_val(__t214);
  ErgoVal __t215 = EV_INT(0);
  ...
  if (__b12) {
    ErgoVal __t217 = EV_STR(stdr_str_lit("filled"));
    ErgoVal __t218 = EV_NULLV;
    {
    ...
    ErgoVal __t219 = EV_STR(stdr_str_lit("tonal"));
    ErgoVal __t220 = EV_NULLV;
    {
  ...
  ErgoVal __t223 = EV_NULLV;
  ErgoVal __t224 = a0; ergo_retain_val(__t224);
  ErgoVal __t225 = EV_INT(1);
  ...
  if (__b13) {
    ErgoVal __t227 = EV_STR(stdr_str_lit("filled"));
    ...
    ErgoVal __t229 = EV_STR(stdr_str_lit("tonal"));
    ErgoVal __t230 = EV_NULLV;
    {
  ...
  if (__b14) {
    ErgoVal __t237 = EV_STR(stdr_str_lit("filled"));
    ErgoVal __t238 = EV_NULLV;
    {
    ...
    ErgoVal __t239 = EV_STR(stdr_str_lit("tonal"));
    ErgoVal __t240 = EV_NULLV;
    {
  ...
  if (__b15) {
    ErgoVal __t247 = EV_STR(stdr_str_lit("filled"));
    ErgoVal __t248 = EV_NULLV;
    {
    ...
    ErgoVal __t249 = EV_STR(stdr_str_lit("tonal"));
    ErgoVal __t250 = EV_NULLV;
    {
...
static ErgoVal ergo_main_build_palette_grid(void) {
  ErgoVal __ret = EV_NULLV;
  ErgoVal group__16 = EV_NULLV;
  ErgoVal __t252 = ergo_cogito_vstack();
  ErgoVal __t253 = EV_BOOL(true);
  ErgoVal __t254 = ergo_m_cogito_VStack_set_hexpand(__t252, __t253);
  ergo_release_val(__t252);
  ergo_release_val(__t253);
  ErgoVal __t255 = EV_INT(12);
  ErgoVal __t256 = EV_INT(18);
  ErgoVal __t257 = EV_INT(18);
  ErgoVal __t258 = EV_INT(18);
  ...
  ErgoVal __t267 = EV_STR(stdr_str_lit("primary"));
  ErgoVal __t268 = EV_NULLV;
  {
  ...
  ErgoVal __t269 = EV_STR(stdr_str_lit("On Primary"));
  ErgoVal __t270 = EV_NULLV;
  {
  ...
  ErgoVal __t271 = EV_STR(stdr_str_lit("on-primary"));
  ErgoVal __t272 = EV_NULLV;
  {
  ...
  ErgoVal __t273 = EV_STR(stdr_str_lit("Primary Container"));
  ErgoVal __t274 = EV_NULLV;
  {
  ...
  ErgoVal __t275 = EV_STR(stdr_str_lit("primary-container"));
  ErgoVal __t276 = EV_NULLV;
  {
  ...
  ErgoVal __t277 = EV_STR(stdr_str_lit("On Primary Container"));
  ErgoVal __t278 = EV_NULLV;
  {
  ...
  ErgoVal __t279 = EV_STR(stdr_str_lit("on-primary-container"));
  ErgoVal __t280 = EV_NULLV;
  {
  ...
  ErgoVal __t283 = EV_STR(stdr_str_lit("Secondary"));
  ErgoVal __t284 = EV_NULLV;
  {
  ...
  ErgoVal __t285 = EV_STR(stdr_str_lit("secondary"));
  ErgoVal __t286 = EV_NULLV;
  {
  ...
  ErgoVal __t287 = EV_STR(stdr_str_lit("On Secondary"));
  ErgoVal __t288 = EV_NULLV;
  {
  ...
  ErgoVal __t289 = EV_STR(stdr_str_lit("on-secondary"));
  ErgoVal __t290 = EV_NULLV;
  {
  ...
  ErgoVal __t291 = EV_STR(stdr_str_lit("Secondary Container"));
  ErgoVal __t292 = EV_NULLV;
  {
  ...
  ErgoVal __t293 = EV_STR(stdr_str_lit("secondary-container"));
  ErgoVal __t294 = EV_NULLV;
  {
  ...
  ErgoVal __t295 = EV_STR(stdr_str_lit("On Secondary Container"));
  ErgoVal __t296 = EV_NULLV;
  {
  ...
  ErgoVal __t297 = EV_STR(stdr_str_lit("on-secondary-container"));
  ...
  ErgoVal __t301 = EV_STR(stdr_str_lit("Tertiary"));
  ErgoVal __t302 = EV_NULLV;
  {
  ...
  ErgoVal __t303 = EV_STR(stdr_str_lit("tertiary"));
  ...
  ErgoVal __t305 = EV_STR(stdr_str_lit("On Tertiary"));
  ErgoVal __t306 = EV_NULLV;
  {
  ...
  ErgoVal __t307 = EV_STR(stdr_str_lit("on-tertiary"));
  ErgoVal __t308 = EV_NULLV;
  {
  ...
  ErgoVal __t309 = EV_STR(stdr_str_lit("Tertiary Container"));
  ...
  ErgoVal __t311 = EV_STR(stdr_str_lit("tertiary-container"));
  ErgoVal __t312 = EV_NULLV;
  {
  ...
  ErgoVal __t313 = EV_STR(stdr_str_lit("On Tertiary Container"));
  ErgoVal __t314 = EV_NULLV;
  {
  ...
  ErgoVal __t315 = EV_STR(stdr_str_lit("on-tertiary-container"));
  ...
  ErgoVal __t319 = EV_STR(stdr_str_lit("Error"));
  ErgoVal __t320 = EV_NULLV;
  {
  ...
  ErgoVal __t321 = EV_STR(stdr_str_lit("error"));
  ...
  ErgoVal __t323 = EV_STR(stdr_str_lit("On Error"));
  ErgoVal __t324 = EV_NULLV;
  {
  ...
  ErgoVal __t360 = EV_STR(stdr_str_lit("Secondary Fixed"));
  ErgoVal __t361 = EV_NULLV;
  {
    ErgoVal __parts125[1] = { __t360 };
    ErgoStr* __s126 = stdr_str_from_parts(1, __parts125);
    __t361 = EV_STR(__s126);
  }
  ergo_release_val(__t360);
  ErgoVal __t362 = EV_STR(stdr_str_lit("secondary-fixed"));
  ErgoVal __t363 = EV_NULLV;
  {
    ErgoVal __parts127[1] = { __t362 };
    ErgoStr* __s128 = stdr_str_from_parts(1, __parts127);
    __t363 = EV_STR(__s128);
  }
  ergo_release_val(__t362);
  ErgoVal __t364 = EV_STR(stdr_str_lit("Secondary Fixed Dim"));
  ErgoVal __t365 = EV_NULLV;
  {
    ErgoVal __parts129[1] = { __t364 };
    ErgoStr* __s130 = stdr_str_from_parts(1, __parts129);
    __t365 = EV_STR(__s130);
  }
  ergo_release_val(__t364);
  ErgoVal __t366 = EV_STR(stdr_str_lit("secondary-fixed-dim"));
  ErgoVal __t367 = EV_NULLV;
  {
    ErgoVal __parts131[1] = { __t366 };
    ErgoStr* __s132 = stdr_str_from_parts(1, __parts131);
    __t367 = EV_STR(__s132);
  }
  ergo_release_val(__t366);
  ErgoVal __t368 = EV_STR(stdr_str_lit("On Secondary Fixed"));
  ErgoVal __t369 = EV_NULLV;
  {
    ErgoVal __parts133[1] = { __t368 };
    ErgoStr* __s134 = stdr_str_from_parts(1, __parts133);
    __t369 = EV_STR(__s134);
  }
  ergo_release_val(__t368);
  ErgoVal __t370 = EV_STR(stdr_str_lit("on-secondary-fixed"));
  ErgoVal __t371 = EV_NULLV;
  {
    ErgoVal __parts135[1] = { __t370 };
    ErgoStr* __s136 = stdr_str_from_parts(1, __parts135);
    __t371 = EV_STR(__s136);
  }
  ergo_release_val(__t370);
  ErgoVal __t372 = EV_STR(stdr_str_lit("On Secondary Fixed Variant"));
  ErgoVal __t373 = EV_NULLV;
  {
    ErgoVal __parts137[1] = { __t372 };
    ErgoStr* __s138 = stdr_str_from_parts(1, __parts137);
    __t373 = EV_STR(__s138);
  }
  ergo_release_val(__t372);
  ErgoVal __t374 = EV_STR(stdr_str_lit("on-secondary-fixed-variant"));
  ErgoVal __t375 = EV_NULLV;
  {
    ErgoVal __parts139[1] = { __t374 };
    ErgoStr* __s140 = stdr_str_from_parts(1, __parts139);
    __t375 = EV_STR(__s140);
  }
  ...
  ErgoVal __t421 = EV_STR(stdr_str_lit("Surface Bright"));
  ErgoVal __t422 = EV_NULLV;
  {
    ErgoVal __parts165[1] = { __t421 };
    ErgoStr* __s166 = stdr_str_from_parts(1, __parts165);
    __t422 = EV_STR(__s166);
  }
  ergo_release_val(__t421);
  ErgoVal __t423 = EV_STR(stdr_str_lit("surface-bright"));
  ErgoVal __t424 = EV_NULLV;
  {
    ErgoVal __parts167[1] = { __t423 };
    ErgoStr* __s168 = stdr_str_from_parts(1, __parts167);
    __t424 = EV_STR(__s168);
  }
  ...
  ErgoVal __t436 = EV_STR(stdr_str_lit("Surface Container Low"));
  ErgoVal __t437 = EV_NULLV;
  {
    ErgoVal __parts173[1] = { __t436 };
    ErgoStr* __s174 = stdr_str_from_parts(1, __parts173);
    __t437 = EV_STR(__s174);
  }
  ergo_release_val(__t436);
  ErgoVal __t438 = EV_STR(stdr_str_lit("surface-container-low"));
  ErgoVal __t439 = EV_NULLV;
  {
    ErgoVal __parts175[1] = { __t438 };
    ErgoStr* __s176 = stdr_str_from_parts(1, __parts175);
    __t439 = EV_STR(__s176);
  }
  ...
  ErgoVal __t442 = EV_STR(stdr_str_lit("Surface Container"));
  ErgoVal __t443 = EV_NULLV;
  {
    ErgoVal __parts177[1] = { __t442 };
    ErgoStr* __s178 = stdr_str_from_parts(1, __parts177);
    __t443 = EV_STR(__s178);
  }
  ergo_release_val(__t442);
  ErgoVal __t444 = EV_STR(stdr_str_lit("surface-container"));
  ErgoVal __t445 = EV_NULLV;
  {
    ErgoVal __parts179[1] = { __t444 };
    ErgoStr* __s180 = stdr_str_from_parts(1, __parts179);
    __t445 = EV_STR(__s180);
  }
  ...
  ErgoVal __t448 = EV_STR(stdr_str_lit("Surface Container High"));
  ErgoVal __t449 = EV_NULLV;
  {
    ErgoVal __parts181[1] = { __t448 };
    ErgoStr* __s182 = stdr_str_from_parts(1, __parts181);
    __t449 = EV_STR(__s182);
  }
  ergo_release_val(__t448);
  ErgoVal __t450 = EV_STR(stdr_str_lit("surface-container-high"));
  ErgoVal __t451 = EV_NULLV;
  {
    ErgoVal __parts183[1] = { __t450 };
    ErgoStr* __s184 = stdr_str_from_parts(1, __parts183);
    __t451 = EV_STR(__s184);
  }
  ...
  ErgoVal __t454 = EV_STR(stdr_str_lit("Surface Container Highest"));
  ErgoVal __t455 = EV_NULLV;
  {
    ErgoVal __parts185[1] = { __t454 };
    ErgoStr* __s186 = stdr_str_from_parts(1, __parts185);
    __t455 = EV_STR(__s186);
  }
  ergo_release_val(__t454);
  ErgoVal __t456 = EV_STR(stdr_str_lit("surface-container-highest"));
  ErgoVal __t457 = EV_NULLV;
  {
    ErgoVal __parts187[1] = { __t456 };
    ErgoStr* __s188 = stdr_str_from_parts(1, __parts187);
    __t457 = EV_STR(__s188);
  }
  ...
  ErgoVal __t469 = EV_STR(stdr_str_lit("On Surface Variant"));
  ErgoVal __t470 = EV_NULLV;
  {
    ErgoVal __parts193[1] = { __t469 };
    ErgoStr* __s194 = stdr_str_from_parts(1, __parts193);
    __t470 = EV_STR(__s194);
  }
  ergo_release_val(__t469);
  ErgoVal __t471 = EV_STR(stdr_str_lit("on-surface-variant"));
  ErgoVal __t472 = EV_NULLV;
  {
    ErgoVal __parts195[1] = { __t471 };
    ErgoStr* __s196 = stdr_str_from_parts(1, __parts195);
    __t472 = EV_STR(__s196);
  }
  ...
  ErgoVal __t475 = EV_STR(stdr_str_lit("Outline"));
  ErgoVal __t476 = EV_NULLV;
  {
    ErgoVal __parts197[1] = { __t475 };
    ErgoStr* __s198 = stdr_str_from_parts(1, __parts197);
    __t476 = EV_STR(__s198);
  }
  ergo_release_val(__t475);
  ErgoVal __t477 = EV_STR(stdr_str_lit("outline-fill"));
  ErgoVal __t478 = EV_NULLV;
  {
    ErgoVal __parts199[1] = { __t477 };
    ErgoStr* __s200 = stdr_str_from_parts(1, __parts199);
    __t478 = EV_STR(__s200);
  }
  ...
  ErgoVal __t481 = EV_STR(stdr_str_lit("Border"));
  ErgoVal __t482 = EV_NULLV;
  {
    ErgoVal __parts201[1] = { __t481 };
    ErgoStr* __s202 = stdr_str_from_parts(1, __parts201);
    __t482 = EV_STR(__s202);
  }
  ergo_release_val(__t481);
  ErgoVal __t483 = EV_STR(stdr_str_lit("outline-variant-fill"));
  ErgoVal __t484 = EV_NULLV;
  {
    ErgoVal __parts203[1] = { __t483 };
    ErgoStr* __s204 = stdr_str_from_parts(1, __parts203);
    __t484 = EV_STR(__s204);
  }
  ...
  ErgoVal __t520 = EV_STR(stdr_str_lit("On Inverse Surface"));
  ErgoVal __t521 = EV_NULLV;
  {
    ErgoVal __parts217[1] = { __t520 };
    ErgoStr* __s218 = stdr_str_from_parts(1, __parts217);
    __t521 = EV_STR(__s218);
  }
  ergo_release_val(__t520);
  ErgoVal __t522 = EV_STR(stdr_str_lit("on-inverse-surface"));
  ErgoVal __t523 = EV_NULLV;
  {
    ErgoVal __parts219[1] = { __t522 };
    ErgoStr* __s220 = stdr_str_from_parts(1, __parts219);
    __t523 = EV_STR(__s220);
  }
  ...
  ErgoVal __t526 = EV_STR(stdr_str_lit("Inverse Primary"));
  ErgoVal __t527 = EV_NULLV;
  {
    ErgoVal __parts221[1] = { __t526 };
    ErgoStr* __s222 = stdr_str_from_parts(1, __parts221);
    __t527 = EV_STR(__s222);
  }
  ergo_release_val(__t526);
  ErgoVal __t528 = EV_STR(stdr_str_lit("inverse-primary-fill"));
  ErgoVal __t529 = EV_NULLV;
  {
    ErgoVal __parts223[1] = { __t528 };
    ErgoStr* __s224 = stdr_str_from_parts(1, __parts223);
    __t529 = EV_STR(__s224);
  }
...
static ErgoVal ergo_main_build_right_panel(void) {
  ErgoVal __ret = EV_NULLV;
  ErgoVal panel__26 = EV_NULLV;
  ErgoVal __t551 = ergo_cogito_vstack();
  ErgoVal __t552 = EV_INT(24);
  ErgoVal __t553 = ergo_m_cogito_VStack_set_gap(__t551, __t552);
  ergo_release_val(__t551);
  ergo_release_val(__t552);
  ErgoVal __t554 = EV_INT(0);
  ErgoVal __t555 = EV_INT(18);
  ErgoVal __t556 = EV_INT(18);
  ErgoVal __t557 = EV_INT(18);
  ...
  ErgoVal upload_hit__28 = EV_NULLV;
  ErgoVal __t574 = EV_STR(stdr_str_lit(""));
  ErgoVal __t575 = ergo_cogito_button(__t574);
  ergo_release_val(__t574);
  ErgoVal __t576 = EV_STR(stdr_str_lit("secondary-container"));
  ErgoVal __t577 = EV_NULLV;
  {
    ErgoVal __parts229[1] = { __t576 };
    ErgoStr* __s230 = stdr_str_from_parts(1, __parts229);
    __t577 = EV_STR(__s230);
  }
  ...
  ErgoVal __t579 = EV_STR(stdr_str_lit("gafu-upload-hit"));
  ErgoVal __t580 = EV_NULLV;
  {
    ErgoVal __parts231[1] = { __t579 };
    ErgoStr* __s232 = stdr_str_from_parts(1, __parts231);
    __t580 = EV_STR(__s232);
  }
  ...
  ErgoVal upload_content__29 = EV_NULLV;
  ErgoVal __t591 = ergo_cogito_vstack();
  ErgoVal __t592 = EV_STR(stdr_str_lit("gafu-upload-content"));
  ErgoVal __t593 = EV_NULLV;
  {
    ErgoVal __parts233[1] = { __t592 };
    ErgoStr* __s234 = stdr_str_from_parts(1, __parts233);
    __t593 = EV_STR(__s234);
  }
  ...
  ErgoVal __t605 = EV_STR(stdr_str_lit("gafu-upload-label"));
  ErgoVal __t606 = EV_NULLV;
  {
    ErgoVal __parts239[1] = { __t605 };
    ErgoStr* __s240 = stdr_str_from_parts(1, __parts239);
    __t606 = EV_STR(__s240);
  }
  ...
  ErgoVal __t615 = EV_STR(stdr_str_lit("gafu-selected-image"));
  ErgoVal __t616 = EV_NULLV;
  {
    ErgoVal __parts241[1] = { __t615 };
    ErgoStr* __s242 = stdr_str_from_parts(1, __parts241);
    __t616 = EV_STR(__s242);
  }
  ...
  ErgoVal __t618 = EV_INT(0);
  ErgoVal __t619 = EV_INT(0);
  ...
  ErgoVal __t654 = EV_FN(ergo_fn_new(ergo_lambda_2, 1));
  ...
  ErgoVal modes__32 = EV_NULLV;
  ErgoVal __t665 = ergo_cogito_buttongroup();
  ErgoVal __t666 = EV_STR(stdr_str_lit("gafu-modes"));
  ErgoVal __t667 = EV_NULLV;
  {
    ErgoVal __parts255[1] = { __t666 };
    ErgoStr* __s256 = stdr_str_from_parts(1, __parts255);
    __t667 = EV_STR(__s256);
  }
  ...
  ErgoVal __t669 = EV_STR(stdr_str_lit("surface-container-lowest"));
  ErgoVal __t670 = EV_NULLV;
  {
    ErgoVal __parts257[1] = { __t669 };
    ErgoStr* __s258 = stdr_str_from_parts(1, __parts257);
    __t670 = EV_STR(__s258);
  }
  ...
  ErgoVal __t707 = EV_FN(ergo_fn_new(ergo_lambda_3, 1));
  ...
  ErgoVal __t710 = EV_FN(ergo_fn_new(ergo_lambda_4, 1));
  ...
  ErgoVal __t713 = EV_FN(ergo_fn_new(ergo_lambda_5, 1));
  ...
  ErgoVal __t716 = EV_FN(ergo_fn_new(ergo_lambda_6, 1));
  ...
  ErgoVal __t739 = EV_STR(stdr_str_lit("gafu-source"));
  ErgoVal __t740 = EV_NULLV;
  {
    ErgoVal __parts269[1] = { __t739 };
    ErgoStr* __s270 = stdr_str_from_parts(1, __parts269);
    __t740 = EV_STR(__s270);
  }
  ...
  ErgoVal source_controls__34 = EV_NULLV;
  ErgoVal __t749 = ergo_cogito_hstack();
  ErgoVal __t750 = EV_INT(6);
  ...
  ErgoVal __t753 = EV_STR(stdr_str_lit("gafu-source-picker"));
  ErgoVal __t754 = EV_NULLV;
  {
    ErgoVal __parts273[1] = { __t753 };
    ErgoStr* __s274 = stdr_str_from_parts(1, __parts273);
    __t754 = EV_STR(__s274);
  }
  ...
  ErgoVal __t772 = EV_FN(ergo_fn_new(ergo_lambda_8, 1));
  ...
  ErgoVal __t784 = EV_FN(ergo_fn_new(ergo_lambda_9, 1));
...
static ErgoVal ergo_stdr_readf(ErgoVal a0, ErgoVal a1) {
  ...
  ErgoVal __t807 = EV_NULLV;
  ergo_release_val(__t807);
  ErgoVal line__35 = EV_NULLV;
  ErgoVal __t808 = EV_STR(stdr_read_line());
  ergo_move_into(&line__35, __t808);
  ErgoVal parsed__36 = EV_NULLV;
...
static ErgoVal ergo_stdr_len(ErgoVal a0) {
  ...
  ErgoVal __t825 = EV_INT(stdr_len(__t824));
...
static ErgoVal ergo_m_cogito_App_set_accent_from_image(ErgoVal self, ErgoVal a0, ErgoVal a1) {
  ...
  if (__b38) {
    ErgoVal __t867 = EV_STR(stdr_str_lit(""));
    ergo_move_into(&__t864, __t867);
  } else {
    ErgoVal __t868 = out__37; ergo_retain_val(__t868);
    ErgoVal __t869 = EV_STR(stdr_to_string(__t868));
...
static void ergo_cogito_pointer_capture(ErgoVal a0) {
  ...
  ErgoVal __t3939 = EV_NULLV;
  ergo_release_val(__t3939);
}

static void ergo_cogito_pointer_release(void) {
  __cogito_pointer_release();
  ErgoVal __t3940 = EV_NULLV;
  ergo_release_val(__t3940);
}

static ErgoVal ergo_cogito_window(void) {
  ErgoVal __ret = EV_NULLV;
  ErgoVal __t3941 = EV_STR(stdr_str_lit("Cogito"));
  ErgoVal __t3942 = EV_NULLV;
  {
    ErgoVal __parts285[1] = { __t3941 };
    ErgoStr* __s286 = stdr_str_from_parts(1, __parts285);
    __t3942 = EV_STR(__s286);
  }
  ergo_release_val(__t3941);
  ErgoVal __t3943 = EV_INT(360);
  ErgoVal __t3944 = EV_INT(296);
...
static void ergo_entry(void) {
  ...
  ErgoVal __t4711 = EV_STR(stdr_str_lit("Gafu"));
  ErgoVal __t4712 = EV_NULLV;
  {
    ErgoVal __parts289[1] = { __t4711 };
    ErgoStr* __s290 = stdr_str_from_parts(1, __parts289);
    __t4712 = EV_STR(__s290);
  }
  ...
  ErgoVal __t4716 = EV_BOOL(false);
  ErgoVal __t4717 = EV_BOOL(false);
  ...
  ErgoVal __t4719 = EV_STR(stdr_str_lit("#65558F"));
  ErgoVal __t4720 = EV_NULLV;
  {
    ErgoVal __parts291[1] = { __t4719 };
    ErgoStr* __s292 = stdr_str_from_parts(1, __parts291);
    __t4720 = EV_STR(__s292);
  }
  ergo_release_val(__t4719);
  ErgoVal __t4721 = EV_BOOL(false);
  ...
  ErgoVal __t4723 = EV_STR(stdr_str_lit("gafu.sum"));
  ErgoVal __t4724 = EV_NULLV;
  {
    ErgoVal __parts293[1] = { __t4723 };
    ErgoStr* __s294 = stdr_str_from_parts(1, __parts293);
    __t4724 = EV_STR(__s294);
  }
  ergo_release_val(__t4723);
  ergo_cogito_load_sum(__t4724);
  ergo_release_val(__t4724);
  ErgoVal __t4725 = EV_NULLV;
  ergo_release_val(__t4725);
  ErgoVal win__41 = EV_NULLV;
  ErgoVal __t4726 = EV_STR(stdr_str_lit("Gafu"));
  ErgoVal __t4727 = EV_NULLV;
  {
    ErgoVal __parts295[1] = { __t4726 };
    ErgoStr* __s296 = stdr_str_from_parts(1, __parts295);
    __t4727 = EV_STR(__s296);
  }
  ergo_release_val(__t4726);
  ErgoVal __t4728 = EV_INT(1720);
  ErgoVal __t4729 = EV_INT(760);
  ...
  ErgoVal right__44 = EV_NULLV;
  ErgoVal __t4756 = ergo_cogito_vstack();
  ErgoVal __t4757 = EV_BOOL(true);
  ...
  ErgoVal __t4767 = EV_STR(stdr_str_lit("sf:arrow.clockwise"));
  ErgoVal __t4768 = EV_NULLV;
  {
    ErgoVal __parts305[1] = { __t4767 };
    ErgoStr* __s306 = stdr_str_from_parts(1, __parts305);
    __t4768 = EV_STR(__s306);
  }
  ergo_release_val(__t4767);
  ErgoVal __t4769 = EV_FN(ergo_fn_new(ergo_lambda_10, 1));
...
static ErgoVal ergo_lambda_1(void* env, int argc, ErgoVal* argv) {
  ...
  ErgoVal arg0 = argv[0];
  ErgoVal __ret = EV_NULLV;
  ErgoVal __t4788 = EV_NULLV;
  {
    ergo_main_choose_source_image();
    ErgoVal __t4789 = EV_NULLV;
...
static ErgoVal ergo_lambda_3(void* env, int argc, ErgoVal* argv) {
  ...
  ErgoVal arg0 = argv[0];
  ErgoVal __ret = EV_NULLV;
  ErgoVal __t4799 = EV_NULLV;
  {
    ErgoVal __t4800 = EV_INT(0);
...
static ErgoVal ergo_lambda_4(void* env, int argc, ErgoVal* argv) {
  ...
  ErgoVal arg0 = argv[0];
  ErgoVal __ret = EV_NULLV;
  ErgoVal __t4810 = EV_NULLV;
  {
    ErgoVal __t4811 = EV_INT(1);
...
static ErgoVal ergo_lambda_5(void* env, int argc, ErgoVal* argv) {
  ...
  ErgoVal arg0 = argv[0];
  ErgoVal __ret = EV_NULLV;
  ErgoVal __t4820 = EV_NULLV;
  {
    ErgoVal __t4821 = EV_INT(2);
...
static ErgoVal ergo_lambda_6(void* env, int argc, ErgoVal* argv) {
  ...
  ErgoVal arg0 = argv[0];
  ErgoVal __ret = EV_NULLV;
  ErgoVal __t4830 = EV_NULLV;
  {
    ErgoVal __t4831 = EV_INT(3);
...
static ErgoVal ergo_lambda_10(void* env, int argc, ErgoVal* argv) {
  ...
  ErgoVal arg0 = argv[0];
  ErgoVal __ret = EV_NULLV;
  ErgoVal __t4854 = EV_NULLV;
  {
    ergo_main_reset_everything();
    ErgoVal __t4855 = EV_NULLV;
...
int main(void) {
  ...
  @autoreleasepool {
    ergo_runtime_init();
    ErgoVal __script_dir = EV_STR(stdr_str_lit("/Users/nayu/Developer/Cogito/extras/gafu"));
